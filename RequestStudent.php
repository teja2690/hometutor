...
<?php
    ...
    $query="select tstation from complete_tutor_details where temail1='$email'";
    $results = mysqli_query($conn, $query);
    $station=mysqli_fetch_array($results);
    $station1=$station['tstation'];
    
	$sql="SELECT * FROM completedetails WHERE station='$station1'"; 
...
<html lang="en">
<head>
<title><a href="tutorpage.php">Home Tutor</title>
                                       ...
                                       <tr>
                                        ...
                                        <?php
                                            while($StudentData=mysqli_fetch_array($results1))
                                           {
                                             ...
                                             echo "<tr>";
                                             echo "<td>".$StudentData['studentName']."</td>";
                                             echo "<td>".$StudentData['dob']."</td>";
                                             echo "<td>".$StudentData['gender']."</td>";
                                             echo "<td>".$StudentData['qualification']."</td>";
                                             echo "<td>".$StudentData['subject']."</td>";
