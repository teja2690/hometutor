...
$sql="INSERT INTO complete_tutor_details(name,tdob,tgender,tqualification,tcourse,taadharNo,tstation,taddress,temail1) values('$NAME','$DOB','$GENDER','$QUALIFICATION','$SUBJECT','$AADHAR','$STATION','$ADDRESS','$email1')"; 
