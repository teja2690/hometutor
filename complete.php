...
<body>
	...
	<div class="logo-navigation-w3layouts">
			...
			<nav class="navbar agileits w3layouts navbar-default">
				...
				<div class="navbar-collapse agileits w3layouts collapse hover-effect" id="navbar">
					<ul class="agileits w3layouts">
                        ...
                        <li><a href="complete.html">Complete Registration</a></li>
                        <li class="agileits w3layouts"><a class="scroll" href="#about">Request a tutor</a></li>
	    ...
	    <div>
		<h3>Complete Registration</h3><br>
              <style type="text/css">
            input, select , textarea {
                width: 400px;
            }
        </style>
			<form action="completedetails.php" method="post">
             
				<center><input type="text" name="cname" placeholder="Student Name" required="required"/><br><br>
				...
				<input type="text" name="course"  placeholder="Subjects you want to study" required="required"/><br><br>	
				<input type="text" name="aadhar"  placeholder="AadharNo" required="required"/><br><br>
                <input type="text" name="Landmark"  placeholder="Nearest Metro Station" required="required"/><br><br>
                <textarea rows="4" cols="50" name="comment" form="usrform">Enter your Complete Address</textarea><br><br>
