...
<!--******************************************************************************************************************************************************-->
<!--Objective:Code to implement home page portal with user profile-->
<!--Author:Tejbahadur-->
<!--Date:25/03/2018-->
<!--******************************************************************************************************************************************************-->
<?php
...
<body>
	...
	<div class="logo-navigation-w3layouts">
			...
			<nav class="navbar agileits w3layouts navbar-default">
				...
				<div class="navbar-collapse agileits w3layouts collapse hover-effect" id="navbar">
					<ul class="agileits w3layouts">
                        ...
                        <li><a href="StudentComplete.php">Complete Registration</a></li>
                        <li><a href="RequestTutor.php">Request a tutor</a></li>
	    ...
	    <div class="banner">
         <br><br><br>
		<h3>Learn & Achieve</h3>
		<h4>We Help Students and Tutors to Find Each Other</h4>
		<div class="arrow">
